...
import com.royasoft.component.album.adapter.IosDialogFolderAdapter;
...
public class AlbumFolderDialogFragment extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        cancel_layout = (RelativeLayout) view.findViewById(R.id.ios_top_layout);
        ...
        if (dialogFolderAdapter == null) {
            dialogFolderAdapter = new IosDialogFolderAdapter(SelectorUtils.createColorStateList(ContextCompat.getColor(getContext(), R.color.albumPrimaryBlack), mToolBarColor), albumFolders, new OnCompatItemClickListener() {
                @Override
